    ...
    <section className="breadcumb-section pt-0">
      <div className="cta-service-v6 cta-banner mx-auto maxw1700 pt120 pb120 bdrs16 position-relative overflow-hidden d-flex align-items-center mx20-lg px30-lg">
        ...
        <img
          ...
          src="/images/vector-img/Blackhards-auction-275by289.png"
          alt=" image "
        />
        <img
          ...
          <div className="row wow fadeInUp">
            <div className="col-xl-7">
              <div className="position-relative">
                <h2 className="text-white">Auctions</h2>
                <p className="text text-white">Bid for the Best</p>
                        ...
                        <form className="form-search position-relative">
                          <div className="box-search">
                            ...
                            <input
                              ...
                              type="text"
                              name="search"
                              placeholder="Keyword or Game Genre or type"
                            />
                          </div>
                        </form>
                      </div>
