        ...
        <div className="container">
          <div className="row mt35">
            ...
            {product1.slice(0, 4).map((item, i) => (
              <div key={i} className="col-sm-6 col-xl-3">
                {item.gallery ? (
                  <PopularGameSlideCard data={item} style="style1" />
                ) : (
          ...
          <div className="row mt35">
            ...
            {product1.slice(0, 4).map((item, i) => (
              <div key={i} className="col-sm-6 col-xl-3">
                {item.gallery ? (
                  <PopularGameSlideCard data={item} style="style2" />
                ) : (
          ...
          <div className="row mt35">
            ...
            {product1.slice(0, 4).map((item, i) => (
              <div key={i} className="col-sm-6 col-xl-3">
                {item.gallery ? (
                  <PopularGameSlideCard data={item} style="style3" />
                ) : (
          ...
          <div className="row mt35">
            ...
            {product1.slice(0, 4).map((item, i) => (
              <div key={i} className="col-sm-6 col-xl-3">
                {item.gallery ? (
                  <PopularGameSlideCard data={item} style="style4" />
                ) : (
