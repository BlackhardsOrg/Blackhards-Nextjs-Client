...
export default function ProfileDetails() {
  ...
  // handlers
  const hourlyHandler = (option: any, value: any) => {
    setHourly({ option, value });
  };
  const genderHandler = (option: any, value: any) => {
    setGender({ option, value });
  };

  const specializationHandler = (option: any, value: any) => {
    setSpecialization({ option, value });
  };
  const typeHandler = (option: any, value: any) => {
