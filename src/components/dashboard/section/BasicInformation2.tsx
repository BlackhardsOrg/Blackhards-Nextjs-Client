...
export default function BasicInformation2() {
  ...
  const freeTypeHandler = (option: any, value: any) => {
    setFreeType({
      option,
      value,
    });
  };
  const priceTypeHandler = (option: any, value: any) => {
    setPriceType({
      option,
      value,
    });
  };
  const projectDurationHandler = (option: any, value: any) => {
    setProjectDuration({
      option,
      value,
    });
  };
  const levelHandler = (option: any, value: any) => {
    setLevel({
      option,
      value,
    });
  ...
  const languageHandler = (option: any, value: any) => {
    setLanguage({ option, value });
  };
  const lanLevelHandler = (option: any, value: any) => {
