...
export default function Skill() {
  ...
  const pointHandler = (option: any, value: any) => {
    setPoint({ option, value });
  };
  const skillHandler2 = (option: any, value: any) => {
    setSkill2({ option, value });
  };
  const pointHandler2 = (option: any, value: any) => {
    setPoint2({ option, value });
  };
  const skillHandler3 = (option: any, value: any) => {
    setSkill3({ option, value });
  };
  const pointHandler3 = (option: any, value: any) => {
              ...
              <div className="row">
                ...
                <div className="col-md-12">
                  <div className="text-start">
                    <Link
                      className="ud-btn btn-thm" href="/contact">
                      Save
