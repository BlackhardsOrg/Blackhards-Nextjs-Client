...
interface IMostViewServiceCard1{
  data: any
}
export default function MostViewServiceCard1({ data }: IMostViewServiceCard1) {
  return (
    <>
      <div className="listing-style1 list-style d-block d-xl-flex align-items-center border-0 mb10">
        <div className="list-thumb flex-shrink-0 bdrs4">
          <img className="w-100 h-auto" src={data.img} alt="thumb" />
        </div>
